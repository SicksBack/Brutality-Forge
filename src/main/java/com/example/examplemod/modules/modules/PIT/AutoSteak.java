...
/*    */ 
/*    */ public class AutoSteak
/*    */   extends Module
/*    */ {
/* 17 */   public NumberSetting health = new NumberSetting("Health", 10.0D, 1.0D, 10.0D, 1.0D);
/* 18 */   public NumberSetting delay = new NumberSetting("Delay", 10000.0D, 75.0D, 10000.0D, 25.0D); private Timer timer; private Timer resettimer; private int currentSlot;
...
/*    */   
/*    */   public AutoSteak() {
/* 22 */     super("AutoSteak", "None", 0, Module.Category.PLAYER, Boolean.valueOf(false));
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* 77 */       if (itemStack != null && itemStack.getItem() == Items.mutton) {
/* 78 */         return i;
/*    */       }
/*    */     } 
/* 81 */     return -1;
...
/* Location:              C:\Users\ASUS\OneDrive\Desktop\clients\paid\scary\Scary.jar!\dev\huys\modules\pit\AutoSteak.class
