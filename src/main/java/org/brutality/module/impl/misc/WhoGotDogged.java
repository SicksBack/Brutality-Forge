...
public class WhoGotDogged extends Module {
    ...
    private final BooleanSetting autoLeave = new BooleanSetting("Auto Leave", this, false);

    public WhoGotDogged() {
        super("WhoGotDogged", "Checks who left the lobby on ban message.", Category.MISC);
